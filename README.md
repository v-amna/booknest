# Book Nest
Online book store to purchase books online. It is a web application built using
the Django framework. The application allows users to browse through a
collection of books, add them to their cart, and make purchases.
